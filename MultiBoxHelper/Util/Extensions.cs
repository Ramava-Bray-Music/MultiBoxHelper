...
internal static class Extensions
{
    ...
    public static byte[] Compress(this byte[] bytes)
    {
        ...
        Service.Log.Verbose($"original: {Dalamud.Utility.Util.FormatBytes(bytes.Length)}, compressed: {Dalamud.Utility.Util.FormatBytes(compress.Length)}, ratio: {(double)compress.Length / bytes.Length:P}");
        return compress;
    }
    ...
    public static T JsonDeserialize<T>(this string str) where T : class
    {
